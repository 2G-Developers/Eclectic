...
<form id="mailform" name="mailform">
    To: <input  name="toemail" type="text" value="krishnan.gopal34@gmail.com" size="40" /><br />
    From: <input name="from" type="text" value="info@eclecticdesigndecor.com" size="40" /><br />
    Subject: <input name="subject" type="text" value="new_enquiry" size="40" />
    
    Message:<br />
    <textarea name="message" rows="15" cols="40">name:<?php echo $_POST['cpname']?> </textarea><br />
    <button type="button" id="sendemail" onclick="GoSend();">Send</button>
